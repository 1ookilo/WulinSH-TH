...
หากกดอัพเดทไปแล้วไม่มีอะไรเกิดขึ้นให้ไปโหลดไฟล์ https://raw.githubusercontent.com/1ookilo/WulinSH-TH/main/BepInEx/plugins/Seiryu.Wulin.NET6/Translations/LocData.json มาวางไว้ในตำแหน่งเดิม
...
# เปิดให้ช่วยแปล
- [ลิงค์โปรเจคแปลใน ParaTranz](https://paratranz.cn/projects/8405) ถ้าใครสนใจอยากจะแปลก็ขอเชิญแวะไปแปลใน ParaTranz ได้เลยนะครับ บอทจะดึงคำแปลจาก paratranz ทุกๆ 6 ชั่วโมง ให้ไปเช็คเปอร์เซ็นความคืบของการแปลในโปรเจค paratranz กันเอาเอง แล้วค่อยมา กด update_localization.bat ตามขั้นตอนรูปด้านบนเพื่ออัพเดทคำแปล 
